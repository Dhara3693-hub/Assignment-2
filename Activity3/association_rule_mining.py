...
frequent_items_1 = frequent_itemsets[frequent_itemsets['itemsets'].apply(lambda x: len(x)>1)] 
frequent_items_1
frequent_items_2= frequent_itemsets[frequent_itemsets['itemsets'].apply(lambda x: len(x)>2)] 
frequent_items_2
frequent_items_3 = frequent_itemsets[frequent_itemsets['itemsets'].apply(lambda x: len(x)>3)] 
frequent_items_3
frequent_items_4 = frequent_itemsets[frequent_itemsets['itemsets'].apply(lambda x: len(x)>=4)]
frequent_items_4
